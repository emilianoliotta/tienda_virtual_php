<?php
    ...
    if (isset($_POST['update'])){
      if (isset($_POST['product_id']) && isset($_POST['name']) && isset($_POST['category_id']) && isset($_POST['description']) && isset($_POST['price']) && isset($_POST['expiration']) && isset($_FILES['image'])){
